...
API. A gateway and gRPC are separate [roadmap](README.md#roadmap) work.
...
3. Use the toolchain required by this release's README: Xcode 26.6 / Swift 6.3.3.
   The core requires iOS 16; the supplied UI requires iOS 17. The examples using
   that UI below require iOS 17.
