...
published state and `onEvent`. The [core quickstart](GETTING_STARTED.md#3b-use-your-own-ui-instead)
...
See the [sample](GETTING_STARTED.md),
[coding-agent handoff](INTEGRATION_AGENT.md), [verification](README.md#verification) and
[follow-up roadmap](README.md#roadmap).
